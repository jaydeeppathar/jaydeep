	...
	<div class="banner-bootom-w3-agileits">
		<div class="container">
			...
			<div class="col-md-5 single-right-left ">
				<div class="grid images_3_of_2">
					<div class="flexslider">
						<ul class="slides">
							<li data-thumb="{{ asset('upload/product/'.$product->image) }}">
								<div class="thumb-image">
									<img src="{{ asset('upload/product/'.$product->image) }}" data-imagezoom="true" class="img-responsive" alt=""> 
								</div>
							</li>
							<li data-thumb="{{ asset('upload/product/'.$product->image) }}">
								<div class="thumb-image">
									<img src="{{ asset('upload/product/'.$product->image) }}" data-imagezoom="true" class="img-responsive" alt=""> </div>
							</li>
							<li data-thumb="{{ asset('upload/product/'.$product->image) }}">
								<div class="thumb-image">
									<img src="{{ asset('upload/product/'.$product->image) }}" data-imagezoom="true" class="img-responsive" alt=""> </div>
			...
			<div class="col-md-7 single-right-left simpleCart_shelfItem">
				...
				<div style="">
					@if($product->status == 0) 
	                 		<label class="badge badge-danger" style="background-color:red;">Out of Stock</label>
	                    @elseif ($product->status == 1) 
	                       <label class="badge badge-success" style="background-color:green;">In Stock</label>
	                @endif
                </div>   
					...
					<li>
						<div class="w3l-specilamk">
							<div class="speioffer-agile">
								<a href="single.html">
									<img src="{{ asset('upload/product/'.$product->image) }}" alt="" height="100px" width="100px">
								</a>
							</div>
