        ...
        <div class="agileinfo-ads-display col-md-12">
            <div class="m-4" style="border:solid 1px black; margin: 10px;">
                {{-- @foreach($subcategory as $subcategory)
                    @if ($subcategory->id == $subcategory->category->id)
            ...
            <div class="wrapper">
                ...
                <div class="product-sec1">
                    <h3 class="heading-tittle">{{ $subcategory->sub_category_name }}</h3>
                        @foreach ($products as $product)
                            @if ($subcategory->sub_category_name == $product->subcategory->sub_category_name)
                                    ...
                                    <div class="men-pro-item simpleCart_shelfItem">
                                        ...
                                        <div class="item-info-product">
                                            ...
                                            <div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
                                                <p class="btn-holder"><a href="{{ route('add.to.cart', $product->id) }}" class="btn add-cart-btn text-center" role="button">Add to cart</a> </p>                                            
                                            </div>
