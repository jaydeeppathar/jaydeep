		...
		<div class="col-md-3 logo_agile">
			<h1>
				<a href="index.html">
					<span>G</span>rocery
					<span>S</span>hoppy
					<img src="frontTheme/images/logo2.png" alt=" ">
				</a>
			</h1>
		</div>
		<!-- header-bot -->
		<div class="col-md-9 header">
			                        ...
			                        @foreach(session('cart') as $id => $details)
			                            <div class="row cart-detail">
			                                <div class="col-lg-4 col-sm-4 col-4 cart-detail-img">
			                                    <img src="{{ asset('upload/product/' .$details['image']) }}" height="40px" width="50px" />
			                                </div>
			...
			{{-- <div class="agileits_search">
				<form action="#" method="post">
					...
					<button type="submit" class="btn btn-default" style="margin-bottom: 30px;" aria-label="Left Align">
			...
			{{-- <div class="top_nav_right"> --}}
		       {{--  <div class="">
		            <div class="dropdown">
			                <button type="button" class="btn btn-info" style="margin-top: 20px;" data-toggle="dropdown">
			                    <i class="fa fa-shopping-cart" aria-hidden="true"></i> Cart <span class="badge badge-pill badge-danger">{{ count((array) session('cart')) }}</span>
			                </button>
			                <div class="dropdown-menu">
			                    <div class="row total-header-section">
		...
		<div class="modal-content">
			...
			<div class="modal-body modal-body-sub_agile">
				...
				<div class="modal_body_left modal_body_left1">
					...
					<p>Sign In now, Let's start your Grocery Shopping. Don't have an account?
						<a href="#" data-toggle="modal" data-target="#myModal2">
							Sign Up Now</a>
					</p>
					<form action="#" method="post">
