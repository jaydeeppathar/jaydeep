        ...
        <div class="card">
            <div class="card-body border-bottom">
                <div class="row" style="margin-bottom: -20px;">
                    <div class="col-md-10">
                      <h4 class="card-title">Contact Offices</h4>
                    </div>
                    <div class="col-md-2" style="text-align:right;">
                      <a href="{{ route('offices.create') }}" class="btn btn-primary head-btn" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Create Offices"><i class="fa fa-plus"></i> Add</a>
                    </div>
                </div>
            </div>
