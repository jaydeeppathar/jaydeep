            ...
            <div class="card-body border-bottom">
                <div class="row" style="margin-bottom: -20px;">
                    ...
                    <div class="col-md-2" style="text-align:right;">
                      <a href="{{ route('whatwedo.create') }}" class="btn btn-primary head-btn" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-original-title="Create"><i class="fa fa-plus" aria-hidden="true"></i> Add</a>
                    </div>
                </div>
            </div>
            <div class="card-datatable table-responsive pt-0">
                <table class="whatwedo-list-table table">
...
<script>
  $(document).ready(function(){
    $(function () {
      ...
      var table = $('.whatwedo-list-table').DataTable({
