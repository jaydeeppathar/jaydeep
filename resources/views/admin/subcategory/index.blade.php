            ...
            <div class="card-body border-bottom">
                <div class="row" style="margin-bottom: -20px;">
                    ...
                    <div class="col-md-2" style="text-align:right;">
                      <a href="{{ route('sub-category.create') }}" class="btn btn-primary head-btn" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-original-title="Create"><i class="fa fa-plus"></i> Add</a>
                    </div>
                </div>
            </div>
